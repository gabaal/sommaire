    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          <Badge
            variant="secondary"
            className="relative px-4 py-1.5 text-sm font-medium bg-white/80 backdrop-blur-xs rouded-full hover:bg-white/90 transition-all duration-300 shadow-xs hover:shadow-md text-rose-500"
          >
      ...
      <div className="self-start">
        <Link href={"/dashboard"}>
          <Button
            variant="link"
            size="sm"
            className="group flex items-center gap-1 sm:gap-2 hover:bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs hover:shadow-md border text-rose-500 border-rose-100/30 bg-rose-100 px-2 ms:px-3 hover:no-underline"
          >
